#Advanced but now working right now
import os
import logging
import requests
...
def main(api_token, bot_token, chat_id):
    ...
    while True:  # Infinite loop to keep the program running
        # Fetch news articles
        articles = fetch_news(api_token)  # You can change the query to any topic
        if not articles:
        ...
        for article in articles:
            ...
            # Wait for 16 minutes before continuing (you can adjust this)
            time.sleep(20)  # Wait for 16 minutes

# Example usage
if __name__ == "__main__":
    api_token = "bc6a8eaddc7aed3ed4a9150079a8addf"  # Replace with your GNews API token
    bot_token = "7433459681:AAHBnT3Xg0Vyum9dmy9UEBYfC7JXfxvtLHk"  # Replace with your Telegram bot token
    chat_id = "-4796752894"  # Replace with your Telegram channel/group ID
